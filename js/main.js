...
if (posts)
  for (var i = 0; i < post_data.length; i++) {
    ...
    <div class="info">
      ...
      <div class="more">
          <img src="show_more.png" alt="show more">
      </div>
    </div>
    <div class="image">
    ...
    <div class="desc">
      <div class="icons">
          <div class="icon_left d-flex">
              <div class="like">
                  <img class="not_loved" src="love.png" >
                  <img class="loved" src="heart.png" >
              </div>
              <div class="chat">
          ...
          <div class="save not_saved">
              <img class="hide saved" src="save_black.png" >
              <img class="not_saved" src="save-instagram.png" >
          </div>
      </div>
      <div class="liked">
